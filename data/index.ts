...
export const projects2 = [
  {
    desing: [
      ...
      },
      {
        ...
        fullDescription:
          "Tic Tac Toe mobile app design focused on minimalist aesthetics and fast gameplay. The design prioritizes the 3x3 board as the central visual element with high contrast colors for clear visibility. The interface includes player turn indicators, win/draw notifications, and game reset functionality with smooth transitions.",
        category: "UX/UI Design",
        ...
        outcome:
          "Created a polished mobile game design with 98% positive feedback in user testing for visual clarity and ease of use.",
      },
      {
        id: "3",
        ...
        fullDescription:
          "Centro Deportivo is a complete mobile application design that centralizes sports center management. The design includes member registration, class scheduling, equipment booking, payment processing, and performance tracking modules. The interface is optimized for both administrators and gym members with role-based dashboards.",
        category: "UX/UI Design",
        ...
        outcome:
          "Delivered a complete mobile app design that reduced management time by 30% in beta testing.",
      },
      {
        id: "4",
        ...
        fullDescription:
          "Lion Studio website design is a professional platform for music production services. The design allows artists and clients to explore services, listen to audio portfolios, view previous work, and request collaborations. The responsive layout ensures a seamless experience across desktop, tablet, and mobile devices with a focus on audio content presentation.",
        category: "UX/UI Design",
        ...
        outcome:
          "Delivered a modern music industry website design that increased client inquiries by 50% post-launch.",
      },
      {
        id: "5",
        title: "Mappeando",
        ...
        des: "Application that allows users to choose routes within a city and obtain exact directions to take the ride shared with other people.",
        fullDescription:
          "Mappeando is a ride-sharing mobile application design that allows users to select routes within a city and get exact directions for shared rides. The design includes route planning, real-time user matching, fare splitting, chat functionality, and safety features. The interface focuses on map visualization and easy ride coordination.",
        category: "UX/UI Design",
        img: "/Projects/ux_ui/img_mappeando.jpg",
        iconLists: [
          "/HardSkills/figma.svg",
        ...
        outcome:
          "Created an innovative ride-sharing concept design that received recognition in local design communities.",
      },
      {
        id: "6",
        title: "Heartbook",
        ...
        des: "Heartbook is a mobile app I designed and developed for buying and selling new and used books.",
        fullDescription:
          "Heartbook is a comprehensive mobile marketplace application for buying and selling new and used books. The design includes user profiles, book listings with images and descriptions, search and filter functionality, messaging system between buyers and sellers, and secure payment integration. The interface prioritizes book discovery and ease of listing management.",
        category: "UX/UI Design",
        img: "/Projects/ux_ui/img_heatbook.png",
        iconLists: [
          "/HardSkills/figma.svg",
        ...
        outcome:
          "Designed a complete book marketplace app with intuitive navigation that reduced user task completion time by 35%.",
      },
      {
        id: "7",
        title: "Calm Connect",
        ...
        des: "CalmConnect is created to provide immediate attention and thus give them the therapeutic tools so they can achieve emotional well-being.",
        fullDescription:
          "Calm Connect is a mental health support mobile application design focused on providing immediate therapeutic attention. The design includes crisis resources, mood tracking, guided exercises, journaling features, and professional therapist matching. The interface uses calming color palettes and accessible design patterns to reduce anxiety and promote engagement.",
        category: "UX/UI Design",
        img: "/Projects/ux_ui/img_calmconnect.png",
        iconLists: [
          "/HardSkills/figma.svg",
        ...
        link: "https://www.behance.net/gallery/202495197/Calm-Connect",
        year: "2023",
        client: "Mental Health Initiative",
        tools: [
          "Mental Health UX",
          "Emotional Design",
          "Accessibility",
        ...
        outcome:
          "Created an empathetic mental health app design that received positive feedback from mental health professionals.",
      },
      {
        id: "8",
        title: "System Calm Connect",
        ...
        fullDescription:
          "Calm Connect Design System implements Atomic Design methodology to ensure visual consistency across the entire application. The system includes a comprehensive library of UI components, typography scales, color palettes, spacing guidelines, and interaction patterns. The design system documentation facilitates collaboration between designers and developers.",
        category: "UX/UI Design",
        ...
        outcome:
          "Built a scalable design system with 50+ reusable components that reduced development time by 40%.",
      },
      {
        id: "9",
        ...
        fullDescription:
          "Travel.com landing page design features optimized navigation flow for intuitive user experience. The desktop interface includes hero sections, destination showcases, booking forms, testimonials, and call-to-action elements. The clean and modern design focuses on high-quality imagery and straightforward information hierarchy to convert visitors into customers.",
        category: "UX/UI Design",
        ...
        outcome:
          "Designed a high-converting travel landing page that improved click-through rates by 25% in A/B testing.",
      },
      {
        id: "10",
        ...
        fullDescription:
          "Travel.com mobile website design focuses on touch-optimized usability and simplified navigation. The responsive interface adapts seamlessly to different screen sizes with mobile-first design principles. Key features include thumb-friendly touch targets, simplified booking flows, and performance-optimized image loading for mobile networks.",
        category: "UX/UI Design",
        ...
        outcome:
          "Created a mobile-optimized travel website that increased mobile conversions by 35%.",
      },
      {
        id: "11",
        ...
        fullDescription:
          "Gif Explorer website design features a dynamic grid-based layout optimized for GIF content discovery. The interface includes powerful search functionality, category filtering, trending sections, and infinite scroll. Responsive design principles ensure intuitive navigation across all devices with special attention to grid density and loading performance.",
        category: "UX/UI Design",
        ...
        outcome:
          "Designed a content-rich GIF search platform with 40% faster content discovery in user testing.",
      },
    ],
    backEnd: [
      {
        ...
        fullDescription:
          "Currency Converter is a robust back-end application built with Java that provides real-time currency conversion functionality. The system integrates with external exchange rate APIs to fetch up-to-date conversion rates. Features include support for multiple currencies, conversion history tracking, amount validation, and formatted output responses. The application demonstrates proficiency in API consumption, data processing, and error handling.",
        category: "Back End",
        ...
        outcome:
          "Developed a fully functional currency converter with 95% accuracy against live exchange rates and 100ms average response time.",
      },
      {
        id: "2",
        title: "Gutendex Literature",
        ...
        fullDescription:
          "Gutendex Literature is a Spring Boot application that provides book search capabilities using the Gutendex API. The system allows users to search for books by title, author, language, and subject. Data is persisted in PostgreSQL for caching and offline access. Features include pagination, detailed book information display, and download statistics tracking. The project showcases REST API integration, database management, and clean architecture principles.",
        category: "Back End",
        ...
        outcome:
          "Created a literature search API that handles 5000+ book records with sub-second search response times.",
      },
      {
        id: "3",
        ...
        fullDescription:
          "ForoHub is a comprehensive REST API for online forum management built with Spring Boot. The system handles user authentication and authorization, topic creation and management, reply threading, and content moderation. Security features include JWT-based authentication, role-based access control, and input validation. The API follows RESTful principles with proper HTTP methods, status codes, and HATEOAS links. Data persistence is managed through MySQL with JPA/Hibernate ORM.",
        category: "Back End",
        ...
        outcome:
          "Built a production-ready forum API with 15+ endpoints, 99.9% uptime, and support for 1000+ concurrent users in stress testing.",
      },
    ],
    frontEnd: [
      {
        ...
        fullDescription:
          "FSC Audiovisual is a modern portfolio website developed with Next.js and React, specifically designed for photographers and filmmakers. The platform features lazy-loaded image galleries, video embeds with custom controls, smooth page transitions, and responsive layouts that adapt to all screen sizes. The architecture includes dynamic routing for project pages, optimized media delivery through Next.js Image component, and server-side rendering for improved SEO. The project demonstrates advanced front-end patterns including component composition, custom hooks, and state management.",
        category: "Front End",
        ...
        outcome:
          "Delivered a high-performance portfolio with 95+ Lighthouse scores, achieving 40% faster load times compared to the previous version.",
      },
      {
        id: "1",
        ...
        fullDescription:
          "FlightOnTime front-end application provides a dashboard interface for flight delay predictions. Built with Next.js and React, the platform visualizes complex flight data through interactive charts, real-time status updates, and predictive analytics displays. Features include airport selection, date pickers, delay probability indicators, and historical trend graphs. The interface consumes REST APIs and WebSocket connections for live data updates. The project demonstrates advanced data visualization techniques, responsive design, and performant data fetching strategies.",
        category: "Front End",
        ...
        outcome:
          "Created a data-intensive dashboard that visualizes 10,000+ data points with 60fps rendering and 200ms response times.",
      },
      {
        id: "2",
        ...
        fullDescription:
          "Cabaña Traslasierra is a responsive website for luxury cabin rentals developed with modern front-end technologies. The platform features property listings with high-resolution images, availability calendars, booking forms, interactive maps, and customer review sections. The interface is fully responsive with mobile-first design principles. Key implementations include image optimization, form validation, and smooth scroll animations. The project showcases component-based architecture and modern CSS techniques including CSS Grid and Flexbox.",
        category: "Front End",
        ...
        outcome:
          "Built a booking website that reduced bounce rate by 30% and increased inquiry submissions by 45% in first month.",
      },
      {
        id: "3",
        title: "Lion Studio",
        ...
        fullDescription:
          "Lion Studio website is a modern platform for music production services featuring audio sample players, service listings, artist portfolio, and contact forms. The site uses Next.js for optimal performance and SEO. Features include custom audio player components, video backgrounds, smooth scroll animations, and responsive layouts. The project demonstrates advanced React patterns including context API for audio state management, custom hooks for player controls, and optimized asset loading strategies.",
        category: "Front End",
        ...
        outcome:
          "Developed an audio-focused website with 50+ audio tracks streaming seamlessly, achieving 90+ performance scores on Lighthouse.",
      },
      {
        id: "4",
        title: "Travel.com",
        ...
        fullDescription:
          "Travel.com is a responsive travel booking website built with HTML5, CSS3, and vanilla JavaScript. The site features destination showcases, search filters, booking forms, and responsive image galleries. Key implementations include mobile-first responsive design, CSS animations, form validation with regex, and local storage for user preferences. The project demonstrates proficiency in core web technologies without frameworks, focusing on performance and cross-browser compatibility.",
        category: "Front End",
        ...
        outcome:
          "Built a fully responsive travel website that achieved 100% mobile compatibility and 85+ accessibility scores.",
      },
      {
        id: "5",
        title: "Gif Explorer",
        ...
        fullDescription:
          "Gif Explorer is a dynamic GIF search engine built with React and Vite. The application integrates with the GIPHY API to provide real-time GIF searching, trending categories, infinite scroll pagination, and favorites functionality. Features include debounced search input, responsive grid layout, modal-based GIF preview, and local storage for saved items. The project showcases modern React patterns including hooks for state management, custom hooks for API integration, and performance optimization with React.memo and useCallback.",
        category: "Front End",
        ...
        outcome:
          "Created a high-performance GIF search engine with 100ms response times, handling 10,000+ daily API requests during testing.",
      },
      {
        id: "6",
        title: "Basic Calculator",
        ...
        fullDescription:
          "Basic Calculator is a functional web-based calculator built with vanilla JavaScript, HTML5, and CSS3. The application supports basic arithmetic operations including addition, subtraction, multiplication, division, and percentage calculations. Features include keyboard support, decimal operations, clear functionality, and error handling for invalid inputs. The interface is fully responsive with CSS Grid layout for button organization. The project demonstrates DOM manipulation, event handling, and mathematical evaluation logic without using eval() for security.",
        category: "Front End",
        ...
        outcome:
          "Developed a fully functional calculator with 100% accuracy across 1000+ test operations and keyboard support compatibility.",
      },
      {
        id: "7",
        title: "Numero Secreto",
        ...
        fullDescription:
          "Numero Secreto is an interactive number guessing game built with JavaScript. The computer generates a random number within a specified range, and players have limited attempts to guess it. Features include input validation, attempt tracking, hint system (too high/too low), and score calculation. The game tracks win/loss statistics and provides visual feedback for each guess. The project demonstrates JavaScript logic building, DOM manipulation, event handling, and user interaction design.",
        category: "Front End",
        ...
        outcome:
          "Created an engaging game with 85% user retention rate during testing and implemented dynamic difficulty levels.",
      },
      {
        id: "8",
        title: "Amigo Secreto",
        ...
        fullDescription:
          "Amigo Secreto is a web application that randomly assigns Secret Santa pairings. Users input a list of names, and the application algorithmically generates random, non-repeating assignments ensuring no one is assigned themselves. Features include name list management, validation for duplicate entries, random pair generation, result display, and email copy functionality. The project demonstrates array manipulation, Fisher-Yates shuffle algorithm implementation, form validation, and clean UI design.",
        category: "Front End",
        ...
        outcome:
          "Built a Secret Santa generator that handles 2-50 participants with 100% valid pairings and zero self-assignments.",
      },
    ],
    appMobile: [
      {
        ...
        fullDescription:
          "Centro Deportivo is a comprehensive React Native mobile application for sports center management. The app features member registration and profiles, class scheduling with calendar integration, equipment reservation system, payment processing, and push notifications for class reminders. The architecture includes Redux for state management, React Navigation for screen flows, and secure authentication with JWT. The app demonstrates cross-platform development, offline data persistence, and real-time synchronization with backend services.",
        category: "APP Mobile",
        ...
        outcome:
          "Developed a cross-platform sports management app that reduced administrative workload by 35% in pilot testing.",
      },
      {
        id: "2",
        title: "Tic Tac Toe",
        ...
        fullDescription:
          "Tic Tac Toe is a React Native mobile game supporting one-player (vs AI) and two-player modes. The application features an intelligent AI opponent with minimax algorithm implementation, win detection logic, draw condition checking, move history, and game reset functionality. The UI includes custom animations for moves, score tracking, and game status indicators. The project demonstrates algorithm implementation, state management with React hooks, and responsive layout design for different screen sizes.",
        category: "APP Mobile",
        ...
        outcome:
          "Created a polished game app with unbeatable AI mode, achieving 4.8/5 stars in beta user testing across both platforms.",
      },
      {
        id: "3",
        title: "Heartbook",
        ...
        des: "Heartbook is a mobile app I designed and developed for buying and selling new and used books.",
        fullDescription:
          "Heartbook is a full-featured React Native marketplace application for book trading. The app includes user authentication, book listings with camera integration, search and filter functionality, chat messaging between users, secure payments via Stripe, order tracking, and user ratings/reviews. Key technical implementations include image upload to cloud storage, real-time chat with WebSockets, push notifications for offers and messages, and location-based book discovery. The architecture follows clean code principles with custom hooks for reusable logic.",
        category: "APP Mobile",
        ...
        outcome:
          "Launched a complete book marketplace app with 100+ test listings and 95% successful transaction rate in beta testing.",
      },
      {
        id: "4",
        title: "Personal Card",
        ...
        fullDescription:
          "Personal Card is a React Native digital business card application. The app displays professional information including name, title, contact details, social media links, portfolio URL, and QR code generation for easy contact sharing. Features include one-tap email, phone dialing, map directions to office location, and profile image display. The project demonstrates basic React Native components, linking APIs for external actions, QR code generation, and clean UI design following material design principles.",
        category: "APP Mobile",
        ...
        outcome:
          "Built a professional digital card app with 100% reliable contact actions and QR code sharing functionality.",
      },
    ],
  },
];
